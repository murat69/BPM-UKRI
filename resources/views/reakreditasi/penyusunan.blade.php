                ...
                <div class="card">
                    ...
                    <div class="col-md-8" style="margin-top: 10px; margin-bottom: 10px;">
                        <button type="button" class="btn btn-primary buttonedit" data-toggle="modal" data-target="#myModal"
                            data-url="{{ route('reakreditasi.store') }}">
                            Tambah Data {{ $title }}
                        </button>
                    </div>
                    <!-- Modal -->
                    <div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="myModal" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('reakreditasi.store') }}" method="post" class="formkirim"
                                        ...
                                        <div class="container">
                                            <div class="row justify-content-center">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="hidden" name="kategori" value="penyusunan" id="">
                        ...
                        <tbody>
                            ...
                            @foreach ($reak as $data)
                                <tr>
                                    ...
                                    @endif
                                    <td>
                                        <form action="{{ route('reakreditasi.destroy', $data->id) }}" method="post">
                                            @csrf
                                            @method('delete')
                                            <a href="" class="btn btn-sm btn-outline-success buttonedit"
                                                data-toggle="modal" data-target="#myModal"
                                                data-nama="{{ $data->nama }}" data-jurusan="{{ $data->jurusan_id }}"
                                                data-old-file="{{ $data->file }}"
                                                data-deskripsi="{{ $data->deskripsi }}"
                                                data-url="{{ route('reakreditasi.update', $data->id) }}">
                                                Edit
                                            </a> |
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.buttonajax', function() {
                ...
                var newURL =
                    "{{ route('reakreditasi', ['kategori' => 'penyusunan', 'kat_fak' => ':kat_fak']) }}";
